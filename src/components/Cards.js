        ...
        <div>
            ...
            <div>
                ...
                className="card ingredients-container" id="card-1">
                    <Ingredient />
                    <p>
                        <input type="checkbox" name="ingredient-2"></input>
                        <label for="ingredient-2"><span className="amount">1 ½ t.</span> Saigon cinnamon (or 2 t. less strong cinnamon)</label>
                    </p>
                    <p>
                        <input type="checkbox" name="ingredient-3"></input>
                        <label for="ingredient-3"><span className="amount" name="ingredient-3">¾ to 1 t</span> 1/3 of a nutmeg, grated—about ¾ to 1 t.</label>
                    </p>
                    <p>
                        <input type="checkbox" name="ingredient-4"></input>
                        <label for="ingredient-4"><span className="amount">2 T.</span> flour</label>                    
                    </p>
                    <p>
                        <input type="checkbox" name="ingredient-5"></input>
                        <label for="ingredient-5"><span className="amount">2 T.</span> tapioca flour</label>                    
                    </p>
                    <p>
                        <input type="checkbox" name="ingredient-6"></input> 
                        <label for="ingredient-6"><span className="amount">3/4 t.</span> salt</label>
                    </p>
                    <p>
                        <input type="checkbox" name="ingredient-7"></input>
                    ...
                    <p>
                        <input type="checkbox" name="ingredient-8"></input>
                        <label for="ingredient-8"><span className="amount">2 T.</span> butter</label>
                    </p>
                    <p>
                        <input type="checkbox" name="ingredient-9"></input>
            ...
            <div>
                ...
                className="card" id="card-1">
                    <div className="step">
                        <p>
                            <input type="checkbox" name="step-1"></input>
                            <label for="step-1">
