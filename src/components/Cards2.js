        ...
        <div>
            <div>
                ...
                <div className="nav-tabs">
                    { (Tab === "Story") ? <div className="nav active"id="Story" onClick={switchTab}>Story</div>  
                    : <div className="nav"id="Story" onClick={switchTab}>Story</div>}
                    { (Tab === "Ingredients") ? <div className="nav active"id="Ingredients" onClick={switchTab}>Ingredients</div>  
                    : <div className="nav"id="Ingredients" onClick={switchTab}>Ingredients</div>}
                    { (Tab === "Steps") ? <div className="nav active"id="Steps" onClick={switchTab}>Steps</div>  
                    : <div className="nav"id="Steps" onClick={switchTab}>Steps</div>}
                    { (Tab === "Images") ? <div className="nav active"id="Images" onClick={switchTab}>Images</div>  
